...
import { Eye, EyeOff, UserPlus, ChevronLeft, Users } from 'lucide-react';
      ...
      <div className="max-w-lg mx-auto">
        <div className="text-center mb-8">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#1a2d5a]/10 rounded-full mb-3">
            <Users size={14} className="text-[#1a2d5a]" />
            <span className="text-xs font-semibold text-[#1a2d5a]" style={{ fontFamily: 'Inter, sans-serif' }}>Individual Donor Account</span>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input value={form.firstName} onChange={e => set('firstName', e.target.value)} placeholder="Jane" className={inp(errors.firstName)} />
            ...
            <div>
              ...
              <input value={form.nickname} onChange={e => set('nickname', e.target.value)} placeholder="What should we call you?" className={inp()} />
            </div>

            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-1.5" style={{ fontFamily: 'Inter, sans-serif' }}>Email Address *</label>
              <input type="email" value={form.email} onChange={e => set('email', e.target.value)} placeholder="jane@example.com" className={inp(errors.email)} autoComplete="email" />
            ...
            <div className="p-4 bg-[#e8eef5] rounded-xl border border-[#1a2d5a]/10">
              <p className="text-xs text-[#1a2d5a] leading-relaxed" style={{ fontFamily: 'Inter, sans-serif' }}>
                🏛️ <strong>Arizona Tax Credit:</strong> As an individual donor you may contribute up to <strong>$1,459 (single)</strong> or <strong>$2,918 (married filing jointly)</strong> and receive a dollar-for-dollar credit on your AZ state taxes.
              </p>
            </div>
            ...
            >
              {loading
                ...
                : <><UserPlus size={16} /> Create Donor Account</>
              }
            </button>
          </form>
